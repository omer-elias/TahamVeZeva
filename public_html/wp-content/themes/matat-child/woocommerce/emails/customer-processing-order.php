...
$banner = $theme_path . '/order-place.png';
    ...
    <tr>
        <td align="center" valign="top" style="padding-bottom:20px" class="imgHero">
            ...
            <a href="#" target="_blank" style="text-decoration:none;">
                <img src="<?php echo $banner; ?>" width="600" alt="" border="0"
        ...
        <tr>
            <td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
                ...
                <p class="text font-primary">
                    <?php printf(__('Thank you for your order', 'matat')); ?>
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td align="center" valign="top" style="padding-bottom:20px;" class="description">
                ...
                <p class="text font-secondary">
                    <?php printf(__('Your order has been received and is now being processed.', 'matat')); ?>
                </p>
            </td>
        </tr>
    </table>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" class="ctaButton">
                            <!-- Button Link // -->
                            <a class="text font-secondary" href="<?php echo $order->get_view_order_url(); ?>"
                               target="_blank">
