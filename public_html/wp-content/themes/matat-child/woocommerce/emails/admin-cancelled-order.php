...
$banner = $theme_path . '/order-cancel.png';
	...
	<tr>
		<td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
			...
			<p class="text font-primary">
				<?php printf(  __( 'Order Cancelation', 'matat' ) ); ?>
			</p>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="padding-bottom:20px;" class="description">
			...
			<p class="text font-secondary">
				<?php printf( __( 'The order #%1$s from %2$s has been cancelled.', 'matat' ), $order->get_order_number(), $order->get_formatted_billing_full_name() ); ?>
			</p>
		</td>
	</tr>
</table>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" class="ctaButton">
						<!-- Button Link // -->
						<a class="text font-secondary" href="<?php echo esc_url( admin_url( 'post.php?post=' . $order->get_id() . '&action=edit' ) ); ?>" target="_blank">
							<?php printf(  __( 'Manage Order', 'matat' ) ); ?>
						</a>
					</td>
				</tr>
			</table>
