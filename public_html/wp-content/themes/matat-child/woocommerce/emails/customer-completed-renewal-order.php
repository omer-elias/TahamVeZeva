	...
	<tr>
		<td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
			...
			<p class="text font-primary">
				<?php printf(  __( 'Order Renewal Completed', 'woocommerce-subscriptions' ) ); ?>	
			</p>
		</td>
	</tr>
		...
		<td align="center" valign="top" style="padding-bottom:20px;" class="description">
			...
			<p class="text font-secondary">
				<?php // translators: placeholder is the name of the site
					printf( esc_html__( 'Hi there. Your subscription renewal order with %s has been completed.', 'woocommerce-subscriptions' ), esc_html( get_option( 'blogname' ) ) );
				?>
			</p>
		</td>
	</tr>
