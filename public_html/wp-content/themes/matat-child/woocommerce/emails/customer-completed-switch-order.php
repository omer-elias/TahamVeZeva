			...
			<td align="center" valign="top" style="padding-bottom:20px;" class="description">
				...
				<p class="text font-secondary">
					<?php
						...
						printf( esc_html__( 'Hi there. You have successfully changed your subscription items on %s. Your new order and subscription details are shown for your reference:', 'woocommerce-subscriptions' ), esc_html( get_option( 'blogname' ) ) );
					?>
				</p>
			</td>
		</tr>
