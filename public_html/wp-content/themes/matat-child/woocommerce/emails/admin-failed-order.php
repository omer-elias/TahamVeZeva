...
$banner = $theme_path . '/order-fail.png';
	...
	<tr>
		<td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
			...
			<p class="text font-primary">
				<?php printf(  __( 'Order Failed', 'matat' ) ); ?>
			</p>
		</td>
	</tr>
	...
	<tr>
		<td align="center" valign="top" style="padding-bottom:20px;" class="description">
			...
			<p class="text font-secondary">
				<?php printf( __( 'Payment for order #%1$s from %2$s has failed.', 'matat' ), $order->get_order_number(), $order->get_formatted_billing_full_name() ); ?>
			</p>
		</td>
	</tr>
</table>
