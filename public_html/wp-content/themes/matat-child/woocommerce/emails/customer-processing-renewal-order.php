...
<tr>
	<td align="center" valign="top" style="padding-bottom:20px" class="imgHero">
		...
		<a href="#" target="_blank" style="text-decoration:none;">
			<img src="<?php echo $theme_path . '/subscription-processing.png' ; ?>" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;" />
		</a>
	</td>
</tr>
		...
		<tr>
			<td align="center" valign="top" style="padding-bottom:10px;" class="mediumTitle">
				...
				<p class="text font-primary">
					<?php printf(  __( 'Subscription Renewal', 'woocommerce-subscriptions' ) ); ?>	
				</p>
			</td>
		</tr>
		...
		<tr>
			<td align="center" valign="top" style="padding-bottom:20px;" class="description">
				...
				<p class="text font-secondary">
					<?php esc_html_e( 'Your subscription renewal order has been received and is now being processed. Your order details are shown for your reference:', 'woocommerce-subscriptions' ); ?>
				</p>
			</td>
		</tr>
	</table>
